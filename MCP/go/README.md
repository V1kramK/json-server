# Json Server API MCP Server

This MCP (Model Content Protocol) server provides access to Json Server API API functionality through HTTP, HTTPS, and STDIO transport modes.
