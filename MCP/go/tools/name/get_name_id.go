...
func Get_name_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_name_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_name_id",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_name_idHandler(cfg),
	}
}
