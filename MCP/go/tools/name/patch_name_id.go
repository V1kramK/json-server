...
func Patch_name_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatch_name_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_name_id",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Patch_name_idHandler(cfg),
	}
}
