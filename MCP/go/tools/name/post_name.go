...
func Post_nameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_nameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_name",
		mcp.WithDescription(""),
