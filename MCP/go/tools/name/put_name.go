...
func Put_nameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_nameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_name",
		mcp.WithDescription(""),
