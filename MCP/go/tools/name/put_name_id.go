...
func Put_name_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_name_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_name_id",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_name_idHandler(cfg),
	}
}
