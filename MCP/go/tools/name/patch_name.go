...
func Patch_nameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/%s", cfg.BaseURL, name)
...
func CreatePatch_nameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_name",
		mcp.WithDescription(""),
